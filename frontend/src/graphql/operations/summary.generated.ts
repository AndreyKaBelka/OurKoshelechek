...
export type SummaryQuery = { summary: { balance: { amount: number }, balanceDeltaMonth: { amount: number }, income: { total: { amount: number } }, expense: { total: { amount: number }, byCategory: Array<{ categoryId: string, amount: { amount: number } }> } } };
